...
train_common_csv_path='train_common.csv'
valid_common_csv_path='valid_common.csv'
# create_common
...
train_gen.reduce_columns(*common_tags,others=False)
train_gen.dataframe.head()
train_gen.save(train_common_csv_path)

valid_gen.reduce_columns(*common_tags,others=False)
valid_gen.dataframe.head()
valid_gen.save(valid_common_csv_path)
train_gen=None
valid_gen=None

train_gen=DFGen(csv_file=train_common_csv_path,csv_sep=',',batch_size=train_batch_size,lambda_func=norm_brvw,tags=common_tags)
valid_gen=DFGen(csv_file=valid_common_csv_path,csv_sep=',',batch_size=valid_batch_size,lambda_func=norm_brvw,tags=common_tags)
train_gen.dataframe.head()
valid_gen.dataframe.head()
