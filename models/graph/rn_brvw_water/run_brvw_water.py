...
train_water_csv_path='train_water.csv'
valid_water_csv_path='valid_water.csv'
# create_water
...
train_gen.reduce_columns(*water_tags,others=False)
train_gen.dataframe.head()
train_gen.save(train_water_csv_path)

valid_gen.reduce_columns(*water_tags,others=False)
valid_gen.dataframe.head()
valid_gen.save(valid_water_csv_path)
train_gen=None
valid_gen=None

train_gen=DFGen(csv_file=train_water_csv_path,csv_sep=',',batch_size=train_batch_size,lambda_func=norm_brvw)
valid_gen=DFGen(csv_file=valid_water_csv_path,csv_sep=',',batch_size=valid_batch_size,lambda_func=norm_brvw)
train_gen.dataframe.head()
valid_gen.dataframe.head()
...
# MODEL-RUN
#
RUN_NAME='rn17-brvw-water-fc2-1'
...
RUN_NAME='rn17-brvw-water-fc2-2'
...
RUN_NAME='rn17-brvw-water-fc2-3'
...
RUN_NAME='rn17-brvw-water-fc2-4'
...
RUN_NAME='rn17-brvw-water-fc2-5'
...
RUN_NAME='rn17-brvw-water-fc2-6'
...
RUN_NAME='rn17-brvw-water-fc2-7'
