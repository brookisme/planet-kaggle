...
train_road_csv_path='train_road.csv'
valid_road_csv_path='valid_road.csv'
# create_road
...
train_gen.reduce_columns(*road_tags,others=False)
train_gen.dataframe.head()
train_gen.save(train_road_csv_path)

valid_gen.reduce_columns(*road_tags,others=False)
valid_gen.dataframe.head()
valid_gen.save(valid_road_csv_path)
train_gen=None
valid_gen=None

train_gen=DFGen(csv_file=train_road_csv_path,csv_sep=',',batch_size=train_batch_size,lambda_func=norm_brvw)
valid_gen=DFGen(csv_file=valid_road_csv_path,csv_sep=',',batch_size=valid_batch_size,lambda_func=norm_brvw)
train_gen.dataframe.head()
valid_gen.dataframe.head()
